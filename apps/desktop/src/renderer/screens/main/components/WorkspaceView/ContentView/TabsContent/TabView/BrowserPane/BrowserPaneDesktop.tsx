...
/**
 * Desktop (Electron) implementation of the Browser pane. Relies on Electron's
 * native `<webview>` tag and the Electron-only `electronTrpc.browser` router,
 * neither of which exists on web — see BrowserPaneWeb for the web fallback.
 */
export function BrowserPaneDesktop({
	paneId,
	path,
	tabId,
	splitPaneAuto,
