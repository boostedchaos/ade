...
export function WaitingOnYouBar({ onClick }: WaitingOnYouBarProps) {
	return (
		<button
			type="button"
			onClick={onClick}
			className="absolute inset-x-0 bottom-0 z-10 flex items-center justify-center gap-2 border-t border-amber-500/40 bg-amber-500/15 px-3 py-2 text-sm font-medium text-amber-700 backdrop-blur-sm transition-colors hover:bg-amber-500/25 dark:bg-amber-400/15 dark:text-amber-300"
		>
