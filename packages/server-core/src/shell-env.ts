 ...
 *
 * Ported from apps/desktop's shell-env.ts (issue #48) so it can be shared by
 * packages/server-core consumers used from both the desktop app and the
 * headless server — this file has no Electron dependency.
 */
